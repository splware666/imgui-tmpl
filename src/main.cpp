...
{
    if (ImGui_ImplWin32_WndProcHandler(window, message, l_param, w_param))
    {
        return 0L;
    }
    ...
    return DefWindowProc(window, message, l_param, w_param);
}
...
INT APIENTRY WinMain(HINSTANCE instance, HINSTANCE, PSTR, INT cmd_show)
{
    ...
    wc.lpszClassName = L"External ImGui Render Class";
